...
/**
 * Frontend data fetching utility with hydration fallback.
 * Attempts to fetch portfolio items from the Sanity API first.
 * If it encounters any error (such as missing CORS, missing dataset, unconfigured variables, or network issues),
 * it immediately catches the error and resolves to returning our existing data.ts array.
 */
...
// Named aliases for flexibility and App Router conventions
export const getPortfolioWork = fetchPortfolioWork;
